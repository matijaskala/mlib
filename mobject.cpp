...
#define all_args (\
    ...
    if ( !receiver->access_slot ( s ) )
        receiver->make_slot ( s, static_cast<std::function<void all_args>> ( [receiver,slot] all_args {
            reinterpret_cast<void(*)all_args>(slot)(r1,r2,r3,r4,r5,r6,r7,r8,f1,f2,f3,f4,f5,f6,f7,f8);
        } ) );
